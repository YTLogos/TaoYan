...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150115.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150131.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150143.png)
```
#使用其他统计检验方法
p+stat_compare_means(method = "t.test")
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150153.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150202.png)
也可以将标签指定为字符向量，不要映射，只需将p.signif两端的..去掉即可
```
p+stat_compare_means(label = "p.signif", label.x = 1.5, label.y = 40)
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150214.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150224.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150235.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150248.png)
...
stat_compare_means()
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150259.png)
```
#使用其他的方法
ggboxplot(ToothGrowth, x="dose", y="len", color = "dose", palette = "jco")+ 
stat_compare_means(method = "anova")
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150311.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150321.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150332.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150343.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150354.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150403.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819150420.png)
```
#可视化
ggboxplot(ToothGrowth, x="dose", y="len", color = "dose", palette = "jco")+
stat_compare_means(method = "anova", label.y = 40)+# Add global p-value
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151326.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151340.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151352.png)
```
#可视化DEPDC1基因表达谱
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151403.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151418.png)
...
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151428.png)
```
#可视化
p <- ggboxplot(ToothGrowth, x="supp", y="len", color = "supp", 
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151438.png)
```
#label绘制显著性水平
p+stat_compare_means(label = "p.signif", label.x = 1.5)
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151448.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151513.png)
```
#只显示p-value
p+stat_compare_means(aes(group=supp), label = "p.format")
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151523.png)
```
#显示显著性水平
p+stat_compare_means(aes(group=supp), label = "p.signif")
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151533.png)
```
进行paired sample检验
compare_means(len~supp, data=ToothGrowth, group.by = "dose", paired = TRUE)
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151544.png)
```
#可视化
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151554.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151605.png)
```
#有误差棒的线图
...
stat_compare_means(ref.group = "0.5", label = "p.signif", label.y = c(22, 29))
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151619.png)
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151632.png)
```
...
```
![](https://raw.githubusercontent.com/YTLogos/pic_link/master/img/20190819151647.png)
